...
<body>
    ...
    <div class="dashboard-buttons">
        ...
        <a href="/DAW2024/exercises/formular">
            <button class="dashboard-btn">Add exercise</button>
        </a>
        ...
        <a href="/DAW2024/classes/formular">
            <button class="dashboard-btn">Add Group Class</button>
        </a>
        <a href="/DAW2024/workouts/index">
            <button class="dashboard-btn">See All Users' Workouts</button>
        </a>
    </div>
